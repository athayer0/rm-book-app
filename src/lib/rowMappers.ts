...
const FIELD_MAPS: Record<string, Record<string, string>> = {
  ...
  settings: {
    ...
    autoOpenContactReport: 'auto_open_contact_report',
    mapsApp: 'maps_app',
...
const COLUMNS: Record<string, string[]> = {
  ...
  settings: [
    ...
    'default_country_code', 'default_contact_method', 'auto_open_contact_report', 'maps_app',
    'daily_review_enabled', 'daily_review_hour', 'daily_review_minute',
    'event_reminder_enabled', 'event_reminder_minutes', 'event_reminder_excluded_type_ids',
    'has_onboarded', 'updated_at',
  ],
};
