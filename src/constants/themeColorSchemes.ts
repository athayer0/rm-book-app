...
export const THEME_COLOR_SCHEMES: ThemeColorScheme[] = [
  ...
  },
  {
    ...
    label: 'Wildflower',
    themeColor: '#B8688A',
    secondaryColorLight: '#79B2BE',
    secondaryColorDark: '#79B2BE',
  ...
  },
  {
    ...
    label: 'Sunset',
    themeColor: '#D15D1A',
    secondaryColorLight: '#BE5592',
    secondaryColorDark: '#BE5592',
  ...
  },
  {
    ...
    label: 'Amazon',
    themeColor: '#1F4A22',
    secondaryColorLight: '#C09D42',
    secondaryColorDark: '#C09D42',
